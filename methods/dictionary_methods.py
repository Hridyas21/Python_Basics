...
print(dict1.get("address","NOT PRESENT")) #if not present, NONE will be output, or we can give what to print
...
dict1.setdefault("language","python") #adds the elements as key-value pair
print(dict1)
